...
{
	if (acao == "fechar") {
		 if (confirm('Tem certeza que deseja fechar esta OS?\n Caso voçê feche esta ordem de serviço ninguém do Núcleo de Tecnologia da Informação irá atender a sua solicitação.')){ 
			 document.formulario.action = "atualizacaoordemfechar.jsp";
	...
	if (acao == "abrir") {
		document.formulario.action = "ordem.jsp";
		document.formulario.submit();
	}
	if (acao == "imprimir") {
