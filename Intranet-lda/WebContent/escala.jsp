			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<h1>INTRANET DPF LDA</h1>
						<p></p>
						<!--  <center><p><img src="img/escudo.jpg" /></p></center>-->
						<form name="loginForm" method="POST" id="searchform" action="gravacaoescala.jsp" onSubmit="return validaDados(this);">
						...
						<div>
							...
							<tr>
								<td><input type="text" value="<%String a="";
								a=Util.DataHojesemHORA();
								out.print(a); %>" name="data" size="20"/></td>
								<!--  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;</td>-->
							</tr>
							</table>
						...
						<div>
							...
							<tr>
								<td>
								<select  name="dataespecial">
								<%out.print(Util.comboboxDataEspecial()); %>
								</select>
								</td>
							</tr>
							</table>
						...
						<div>
							...
							<tr>
								<td>
								<select  name="plantonista1">
								<%out.print(Util.comboboxUSUARIOS()); %>
								</select>
								</td>
							</tr>
							</table>
						...
						<div>
							...
							<tr>
								<td>
								<select  name="agente1">
								<%out.print(Util.comboboxAGENTES()); %>
								</select>
								</td>
							</tr>
							</table>
						...
						<div>
							...
							<tr>
								<td>
								<select  name="escrivao">
								<%out.print(Util.comboboxESCRIVAO());%>
								</select>
								</td>
							</tr>
							</table>
						...
						<div>
							...
							<tr>
								...
								<%out.print(Util.comboboxDELEGADO());%>
								</select>
								</td>
							</tr>
							</table>
						...
						<div>
							...
							<tr>
								<td>
								<select  name="papiloscopista">
								<%out.print(Util.comboboxPAPILOSCOPISTA());%>
								</select>
								</td>
							</tr>
							</table>
