			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<p></p>
						<p>MODULO - FUNÇÕES - APAGAR</p>
						<FORM NAME=funcoesapagar method=Post action=funcoesapagarcad.jsp >
						<div>
							<table class="search">
							<tr>
								<td>
						...
						<div>
							...
							<tr>
								<td>
								<br><br><center><input type=button onclick='pergunta()' name='enviar' value='Apagar Selecionado'></center>
								<td>
							</tr>
							</table>
						</div>
