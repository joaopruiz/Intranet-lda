...
titulo1.setSize(8);
Font  titulo2 = new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE, Font.NORMAL);
titulo2.setSize(4);
...
Font red = FontFactory.getFont(FontFactory.HELVETICA, Font.DEFAULTSIZE, Font.BOLD, new Color(0xFF, 0x00, 0x00));
	...
	Paragraph pr = new Paragraph("SERVIÇO PÚBLICO FEDERAL", titulo2);
	pr.setAlignment(Element.ALIGN_CENTER);
	Paragraph pr1 = new Paragraph("MJ - DEPARTAMENTO DE POLÍCIA FEDERAL", titulo2);
	pr1.setAlignment(Element.ALIGN_CENTER);
	Paragraph pr2 = new Paragraph("SR/PR - DIVISÃO DE POLÍCIA FEDERAL EM LONDRINA", titulo2);
	...
	//logotipo e linhas 1 a 3
	document.add(imagem);
	document.add(pr);
	document.add(pr1);
	document.add(pr2);
	//termina aki as linha 1 a 3
