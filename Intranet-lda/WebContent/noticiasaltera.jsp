			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<form name="loginForm" method="POST" id="searchform" action="gravacaonoticiasaltera.jsp">
						...
						<div>
							...
							String[] dadosuser;
							dadosuser = Util.selectTudoNoticia(i);
							%>
							<tr>
								<td><INPUT TYPE="text"  NAME='titulo' VALUE="<%=dadosuser[0]%>" size="80"></td>
							</tr>
							</table>
						</div>
						...
						<div>
							...
							<tr>
								<td>
								<INPUT TYPE="text" NAME='expira' VALUE="<%=dadosuser[2] %>" readonly="readonly" size='30' onchange='enviar(this.name)'>
								</td>
							</tr>
							</table>
						</div>	
						...
						<div>
							...
							<tr>
								<td>
								<textarea NAME='descricao' COLS='61' ROWS='20'><%=dadosuser[1] %></textarea>
								</td>
							</tr>
							</table>
						</div>
