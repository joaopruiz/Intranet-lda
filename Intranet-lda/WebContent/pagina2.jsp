...
function enviar(acao)
{
	...
	if (acao == "ler") {
		document.formulario.action = "ordensleitura.jsp";
		document.formulario.submit();
	}
	...
	if (acao == "nova") {
		document.formulario.action = "novaordem.jsp";
		document.formulario.submit();
	}
	if (acao == "imprimir") {
		document.formulario.action = "pdfos.jsp";
		document.formulario.submit();
	}
}
</script>
			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<p><%String msg2 = (String) request.getParameter("interno");
								if (msg2 != null)
	   									out.print(msg2);
								%></p>
						...
						<div>
							<table class="search">
							<tr>
								<td><h1><%=Util.retornaBomDia() %></h1></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td>Nesse mês você estará de plantão e/ou sobreavisos nos seguintes dias:</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
							<%=Util.imprimeEscalaPagina(Util.DataHojesemHORA(), (String)session.getAttribute("usuario")) %>
							<tr>
								<td>&nbsp;</td>
							</tr>
							<tr>
						...
						<%out.print(Util.ordensMasterAtendente((String)session.getAttribute("usuario"))); %>
