			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_title">
						<h1 class="left">ALTERAÇÃO DE CONTEÚDO<a href="#"></a></h1>
					...
					<div class="post_body">
						<%
								ArrayList<BeanLayout> layouts = Util.retornaLayoutArrayList();
								BeanLayout lt1 = (BeanLayout)layouts.get((Integer.parseInt(request.getParameter("id"))-1));
								%>
					
						<p></p>
						<p>MODULO - ALTERAÇÃO DE CONTEÚDO - <%=lt1.getDescricao() %></p>
						<form name="loginForm" method="POST" id="searchform" action="gravacaoalteralayout.jsp">
						<div>
							<table class="search">
							<tr>
								<td><h1 class="sysmsg">
						...
						<div>
							<table class="search">
							<tr>
								<td><a href="alteracaoconteudo.jsp" >Voltar...</a></td>
							</tr>
							</table>
						</div>		
						<div>
						...
						<div>
							<table class="search">
							<tr>
								<td><%=lt1.getDescricao() %>:</td>
							</tr>
							<tr>
								<td>
								<textarea NAME='conteudo' COLS='61' ROWS='20'><%=lt1.getConteudo()%></textarea>
								<input type='hidden' value='<%=lt1.getId()%>' name=id>
								</td>
							</tr>
							</table>
						</div>
						...
						<div>
							<table class="search">
							<tr>
								<td style="padding-left: 10px"><a href="alteracaoconteudo.jsp" >Voltar...</a>	</td>
							</tr>
							</table>
						</div>	
						</form>
