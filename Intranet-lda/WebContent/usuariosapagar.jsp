...
function pergunta(){ 
	   if (confirm('Tem certeza que quer apagar este usuario?')){ 
		   document.formularioapagar.submit() 
	   } 
	} 
</script> 
			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<FORM NAME=formularioapagar method=Post action=apagarusuario.jsp >
						<%out.print(Util.apagarUsuarios()); %>
						</form>
					</div>
		...
		<div class="left" id="main_right">
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box_body">
						<form name="loginForm" method="POST" id="searchform" action="index.jsp">
