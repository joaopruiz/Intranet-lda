	...
	<div id="main">
		...
		<div class="right" id="main_left">
			...
			<div id="main_left_content">
				...
				<div class="post">
					<%
								ArrayList<BeanConteudo> lotacoes= Util.retornaConteudoArrayList();
								BeanConteudo lt1 = (BeanConteudo)lotacoes.get((Integer.parseInt(request.getParameter("id"))-1));
								%>
					<div class="post_title">
						<h1 class="left"><%=lt1.getDescricao() %><a href="#"> </a></h1>
