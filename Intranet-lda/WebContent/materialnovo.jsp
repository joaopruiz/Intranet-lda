			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<form name="loginForm" method="POST" action="materialnovosalvar.jsp" >
						...
						<div>
							...
							<tr>
								<td><input type="text" value="" name="descricao" size="80" /></td>
							</tr>
							</table>
						</div>
						<div>
						...
						<div>
							...
							<tr>
								<td><input type="text" value="" name="quantidade" size="50" onKeyPress="ajustar_data(this)"/></td>
							</tr>
							</table>
						</div>
						<div>
						...
						<div>
							...
							<tr>
								<td><input type="text" value="" name="valor"  size='50' onKeyPress="ajustar_data(this)"/></td>
							</tr>
							</table>
						</div>
						<div>
