			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<FORM NAME=formalterar method=Post action=usuariosalterarlogin.jsp onSubmit="return defaultagree(this)">
						<%out.print(Util.alterarUsuarios()); %>
						</form>
					</div>
		...
		<div class="left" id="main_right">
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box_body">
						<ul>
						<li><a href="usuariosmaster.jsp">USUÁRIOS</a></li>
