...
<%if(session.getAttribute("usuario") == null){
	...
	if(Util.alteraCargo(gravafuncao)==true){
		pageContext.forward("cargosmaster.jsp?msgi=Cargo alterado com sucesso.");
	}else{
		pageContext.forward("cargosmaster.jsp?msgi=Erro na gravação.....");
	}			
%>
</body>
</html>