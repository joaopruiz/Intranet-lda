...
{
	if (acao == "apagar") {
		 if (confirm('Tem certeza que quer apagar esta notícia?')){ 
			 document.formulario.action = "noticiasapagar.jsp";
	...
	if (acao == "novo") {
		document.formulario.action = "noticia.jsp";
		document.formulario.submit();
	}
}
</script>
			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<p></p>
						<p>MODULO - NOTÍCIAS - GERENCIAR</p>
						
						<div>
							<table class="search">
							<tr>
								<td><h1 class="sysmsg">
								<% String msgexc = (String) request.getParameter("msgit");
								if (msgexc != null){
	   									out.print(msgexc);
	   							}%></h1>
								</td>
