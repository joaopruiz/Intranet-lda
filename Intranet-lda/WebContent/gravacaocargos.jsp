...
<%if(session.getAttribute("usuario") == null){
	...
	if(Util.gravaNovoCargo(gravafuncao)==true){
		pageContext.forward("cargosmaster.jsp?msgi=Novo cargo adicionado com sucesso.");
	}else{
		pageContext.forward("cargos.jsp?msgi=Erro na gravação.....");
	}			
%>
</body>
</html>