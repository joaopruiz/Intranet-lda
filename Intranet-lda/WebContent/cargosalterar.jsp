			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<form name="loginForm" method="POST" id="searchform" action="gravacaocargosalterar.jsp" onSubmit="return validaDadosCampo(this);">
						<%int qt=0;
							String[] loginarray = request.getParameterValues("codigo_cargo");
							qt=Integer.parseInt(loginarray[0]);
							String dadosuser;
							dadosuser = Util.selectCargoDescricao(qt);
							%>
						<div>
							<table class="search">
							<tr>
