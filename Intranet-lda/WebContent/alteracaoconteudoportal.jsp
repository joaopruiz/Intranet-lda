		...
		<div class="right" id="main_left">
			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						<%
							BeanConteudo lt1 = Util.retornaConteudoid(Integer.parseInt(request.getParameter("id")));
						%>
					
						<p></p>
						<p>MODULO - ALTERAÇÃO DE CONTEÚDO - <%=lt1.getDescricao() %></p>
						<form name="loginForm" method="POST" id="searchform" action="gravacaoalteraconteudo.jsp">
						<div>
							<table class="search">
							<tr>
								<td><h1 class="sysmsg">
