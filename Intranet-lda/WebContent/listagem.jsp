...
function enviar(acao)
{
	if (acao == "apagar") {
		 if (confirm('Tem certeza que deseja apagar este patrimonio?')){ 
			 document.formulario.action = "apagarequip.jsp";
			 document.formulario.submit();
		   } 
	}

	if (acao == "alterar") {
		document.formulario.action = "patrimonio.jsp";
		document.formulario.submit();
	}

	if (acao == "novo") {
		document.formulario.action = "patrimonionovo.jsp";
		document.formulario.submit();
	}
}
</script>
			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<%=Util.usuariosEquipamentos(Integer.parseInt((String)session.getAttribute("userequip"))) %>
						</form>
					</div>
