			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<p></p>
						<p>MODULO - ALTERAÇÃO DE CONTEÚDO - MENUS</p>
						<form name="loginForm" method="POST" id="searchform" action="gravacaoalteraconteudomenus.jsp">
						<div>
							<table class="search">
							<tr>
								<td><h1 class="sysmsg">
						...
						<div>
							<table class="search">
							<tr>
								<td><a href="alteracaomenus.jsp" >Voltar...</a></td>
							</tr>
							</table>
						</div>		
						<div>
						...
						<div>
							...
							<tr>
								<td>
								<textarea NAME='conteudo' COLS='61' ROWS='20'><%=Util.retornaMenu(Integer.parseInt(request.getParameter("funcao")))%></textarea>
								<input type='hidden' value='<%=request.getParameter("funcao") %>' name=funcao>
								</td>
							</tr>
							</table>
						</div>
						...
						<div>
							<table class="search">
							<tr>
								<td style="padding-left: 10px"><a href="alteracaomenus.jsp" >Voltar...</a>	</td>
							</tr>
							</table>
						</div>	
						</form>
