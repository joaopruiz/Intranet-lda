			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<p></p>
						<p>MODULO - USUÁRIOS - ALTERAR</p>
						
						<form name="loginForm" method="POST" action="alterarusuario.jsp" onSubmit="return Dadosjp(this);">
						...
						<div>
							...
							<tr>
								<td><input type="hidden" value="<%if(dadosuser[13].equals(null) || dadosuser[13].equals("0")){out.print("");}else{out.print(dadosuser[13]);} %>" name="matricula" size="20" onKeyPress="ajustar_data(this)"/><%if(dadosuser[13].equals(null) || dadosuser[13].equals("0")){out.print("");}else{out.print(dadosuser[13]);} %></td>
								<!--  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;</td>-->
							</tr>
							</table>
						...
						<div>
							...
							<tr>
								<td><input type="hidden" value="<%=dadosuser[22] %>" onkeypress="Mascara('cpf', window.event.keyCode, 'document.loginForm.cpf');" maxLength=14 size=14 name="cpf"  /><%=dadosuser[22] %></td>
							</tr>
							</table>
						</div>
						<div>
						...
						<div>
							...
							<tr>
								<td><input type="hidden" maxLength=10 size=10 name="admissao" value="<%=(dadosuser[15])%>" onkeypress="Mascara('nascimento', window.event.keyCode, 'document.loginForm.admissao');"  /><%=(dadosuser[15])%></td>
								<!--  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;</td>-->
							</tr>
							</table>
						...
						<div>
							...
							<tr>
								...
								<!--<option selected value="cargo">Cargo</option>-->
								<%out.print(Util.selectFuncaoAlterarCadastro(dadosuser[5])); %>
								<%out.print(Util.selectFuncaoAlterarLogin(dadosuser[5])); %>
								</select>
								</td>
							</tr>
							</table>
