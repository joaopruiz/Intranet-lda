		...
		<div class="right" id="main_left">
			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						<p></p>
						<p>MODULO - ALTERAÇÃO DE CONTEÚDO - NOVO CONTEÚDO</p>
						<form name="loginForm" method="POST" id="searchform" action="gravacaonovolayout.jsp" onSubmit="return validaDadosCampo(this);">
						<div>
							<table class="search">
							<tr>
								<td><h1 class="sysmsg">
						...
						<div>
							...
							<tr>
								<td>
								Conteúdo: <textarea NAME='conteudo' COLS='61' ROWS='20'></textarea>
