			...
			<div id="main_left_content">
				...
				<div class="post">
					...
					<div class="post_body">
						...
						<form name="loginForm" method="POST" id="searchform" action="gravacaolotacoessalterar.jsp" onSubmit="return validaDadosCampo(this);">
						<%int qt=0;
							String[] loginarray = request.getParameterValues("codigo_funcao");
							qt=Integer.parseInt(loginarray[0]);
							String dadosuser;
							dadosuser = Util.selectLotacaoDescricao(qt);
							%>
						<div>
							<table class="search">
							<tr>
							...
							<tr>
								<td><input type="text" value="<%out.print(dadosuser);%>" name="nome" size="50"/></td>
							</tr>
							<tr>
								<td><input type="hidden" value="<%out.print(qt);%>" name="id" size="50"/></td>
							</tr>
							</table>
						</div>
